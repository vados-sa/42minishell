...
#    Updated: 2024/09/05 14:45:47 by vados-sa         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = $(SRCDIR)/main.c $(SRCDIR)/signals.c \
	  $(LEXING_DIR)/checker.c $(LEXING_DIR)/delete.c $(LEXING_DIR)/handler.c \
	  $(LEXING_DIR)/lex.c $(LEXING_DIR)/token.c \
	  $(PARSING_DIR)/command.c $(PARSING_DIR)/concat_expanded_vars.c \
	  $(PARSING_DIR)/delete.c $(PARSING_DIR)/expander_utils.c \
	  ...
	  $(BUILTINS_DIR)/builtin_utils.c $(BUILTINS_DIR)/cd.c $(BUILTINS_DIR)/echo.c \
